...
@pytest.mark.parametrize(
    ...
    [
        (1, (COLOR_DARK_BLUE, COLOR_LIGHT_BLUE)),
        (2, (COLOR_DARK_GREEN, COLOR_GREEN)),
        (3, (COLOR_DARK_PURPLE, COLOR_LAVENDER)),
        (4, (COLOR_BROWN, COLOR_ORANGE)),
        (5, (COLOR_DARK_GRAY, COLOR_WHITE)),
        (6, (COLOR_RED, COLOR_PINK)),
        (7, (COLOR_ORANGE, COLOR_YELLOW)),
        (8, (COLOR_YELLOW, COLOR_CYAN)),
        (9, (COLOR_GREEN, COLOR_LIGHT_BLUE)),
        (10, (COLOR_CYAN, COLOR_LAVENDER)),
    ],
)
